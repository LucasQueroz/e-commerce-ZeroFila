                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="/www/ZeroFila/admin/class/InserirProduto.php">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Nome do Produto</label>
                                                <input id="inputText3" type="text" class="form-control" name="nome">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputText3" type="text" class="form-control" name="valor">
                                            </div>
                                            <!-- Botões do form -->
                                            <div class="col-md-8">
